...
import { FeatherIcon, ShareIcon, FacebookIcon, TwitterIcon, LinkedinIcon } from "../icons"
...
export default function BlogPost({ params }) {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <header className="bg-background px-4 py-3 border-b sticky top-0 z-50">
      ...
      <main className="flex-1 container mx-auto px-4 py-8">
        <article className="max-w-3xl mx-auto">
          <p className="text-lg mb-6">{post.title}</p>
