...
import Social from '@/app/components/Social/index.js';
import ProgressBar from '@/app/components/ProgressBar/index.js';
import Inferior from '@/app/components/Footer/index.js';
...
export default function ServiceDetails({ params }) {
    ...
    return (
      <>
        ...
        <div id="especificacoes" className="mt-60 mb-20 lg-mt-30 lg-mb-10">
          <div className="row gx-xxl-5">
            <ProgressBar data={service.progressData} />
          </div>
        </div>
