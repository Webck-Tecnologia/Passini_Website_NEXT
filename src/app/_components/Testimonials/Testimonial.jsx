  ...
  const testimonials = [
    {
      ...
      feedback:
        "A revolução no transporte de cargas suspensas em canteiros de obra! Se você está procurando uma solução eficiente e segura para movimentar materiais pesados, em canteiros apertados, aqui está a solução!",
      name: "John Doe",
    },
    {
      id: 2,
